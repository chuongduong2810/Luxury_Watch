...
if (isset($_GET['delete'])){
	include 'php/address-page/del-address.php';
}
if (isset($_GET['selectAddress'])){
	if(!isset($_SESSION['transaction'])){
		header('Location: cart.php');
	}else{
		include 'php/address-page/select-address.php';
	}
						...
						<ul class="left-body__main-list">
							<li class="left-body__main-list-profile">
								...
								<ul class="left-body__main-list-profile-container">
									...
									<li><a href="./address.php" class="mb-2 active">Địa chỉ</a></li>
				...
				<div class="col-md-9 col-sm-9 right-part">
					<div class="right-part__header">
						<div class="row justify-content-between ml-2 mr-2">
							<h3 style="line-height: 38px;">Thông tin giao hàng</h3>
							<a class="btn btn-success btn-select-avt btn-new-address" href="./newaddress.php" role="button">
					...
					<div class="right-part__body">
						<?php include 'php/address-page/load-address.php'?>
