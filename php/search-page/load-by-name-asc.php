<?php
	...
	$sql = "SELECT productID, product_name, stock, price, imagesource, product_brand FROM product WHERE product_name LIKE '%{$keyword}%' ORDER BY product_name ASC";
		...
		<div class="col-sm-12 col-md-6 col-lg-4">
			...
			<div class="product-grid <?=$row["product_brand"]?>">
				...
				<div class="product-content">
					...
					?></div>
					<ul class="rating">
						<li class="fa fa-star uncheck"></li>
