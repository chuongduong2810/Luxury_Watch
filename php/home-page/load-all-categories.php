<?php
	...
	$sql = "SELECT productID, product_name, stock, price, imagesource, product_brand FROM product ORDER BY product_name ASC";
	$result = $conn->query($sql);
	while($row = $result->fetch_assoc())  {    ?>
		<div class="col-sm-12 col-md-6 col-lg-4 product-more brand-now">
			<!-- product_brand -->
