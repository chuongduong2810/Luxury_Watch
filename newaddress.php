...
if(isset($_POST['btn_createAddress'])){
	include 'php/address-page/create-new-address.php';
}
			...
			<div class="row">
				...
				<div class="col-md-9 col-sm-9 right-part">
					...
					<div class="right-part__body">
						<div class="container">
							<div class="row">
								<form id="form_createNew" method="post" action="#">
								<div class="form-group form-change-pass">
									<div class="row info-input">
										<label for="">Họ và tên</label> 
										<input class="input-long" type="text" name="fullname" required>
									</div>

									<div class="row info-input">
										<label for="">Số điện thoại</label> 
										<input class="input-long" type="text" name="phone" required pattern="[0-9]{9,11}" title="SĐT từ 10 đến 11 chữ số">
									</div>				

									<div class="row info-input">
										<label for="">Địa chỉ</label> 
										<input class="input-long" type="text" name="address" required>
									</div>

								  <!-- <button type="submit" onclick="document.getElementById('form_createNew').submit()" class="btn btn-success btn-save btn-changepass-save">Lưu</button> -->
								  <input type="submit" class="btn btn-success btn-save btn-changepass-save" name="btn_createAddress" value="Save"></input>
